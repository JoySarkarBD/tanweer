...
export default function AboutPrograms() {
  ...
  return (
    <>
      <div className=" pt-[80px] bg-[#C06F39] ">
                    ...
                    <div>
                      ...
                      <div className="text-[#FFF7E0] xl:pt-[70px] lg:pt-[55px] md:pt-[45px] xl:w-[631px] lg:w-[475px] md:w-[300px] flex flex-col  ms-auto">
                        <p className=" xl:text-[26px] lg:text-[22px] md:text-[18px] pb-[26px] flex justify-end">
                          This is why we are bringing together artists from
                          around the world who understand our message, and the
                          need to revive and bring back our ancient wisdom
                          through sacred songs and traditional music – music
                          that will help us remember our past and revive our
                          traditions. This is Tanweer.
                          <br />
                          <br />
                          Tanweer means enlightenment – a meeting of minds and
                          hearts. Tanweer will bring together the keepers of
                          wisdom to raise our collective frequency and connect
                          us with our past. Thank you for joining us. With love
                          and gratitude,
                          <br />
                          <br />
                          Bodour Al Qasimi
                  ...
                  <div className="flex flex-col pt-[31px]">
                    ...
                    <div className="xsm:w-[319px] sm:w-[329px] xmd:w-[399px] mx-auto pt-[32px] pl-12">
                      <p className="text-[#FFF7E0] sm:text-[18px] xsm:text-[14px] xmd:text-[20px] text-left font-normal leading-[26px]">
                        ...
                        ancient wisdom through sacred <br /> songs and
                        traditional music – music <br /> that will help us
                        remember our past <br />
                        and revive our traditions. This is <br /> Tanweer.
                        <br />
                        <br />
                        Tanweer means enlightenment – a <br /> meeting of minds
                        and hearts. <br /> Tanweer will bring together the{" "}
                        <br /> keepers of wisdom to raise our <br /> collective
                        frequency and connect us <br /> with our past. Thank you
                        for joining <br />
