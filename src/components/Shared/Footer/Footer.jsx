    ...
    <>
      <footer className='text-white cursor-pointer body-font bg-[#BE7649]'>
        <div className='md:footer_container lg:px-24 py-24 mx-auto flex md:items-center lg:items-start md:flex-col md:flex-nowrap flex-wrap flex-col md:px-5 lg:flex-row'>
          {/* First Column */}
          <div className='w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left lg:mt-6'>
          ...
          <div className='grid grid-cols-1 justify-between md:pl-0 -mb-10 md:mt-5 mt-10 md:text-left text-center md:grid-cols-2 xl:grid-cols-5 2xl:grid-cols-5 lg:grid-cols-3 lg:mt-0 lg:max-w-5xl lg:mx-auto '>
