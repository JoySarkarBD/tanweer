      ...
      <div className="min-h-screen bg-[#C06F39;] flex items-center py-6 lg:py-6">
        <div className="flex items-center justify-between w-full container flex-col space-y-12 lg:space-y-0 lg:flex-row md:flex-col md:space-y-12">
          <div className="text-center">
            <h1 className="text-[#FFE88C] text-[56px] leading-[69px] font-normal lg:text-[75px] lg:leading-[100px] md:text-[75px] md:leading-[100px]">
              GET YOUR <br />
              TICKETS NOW
            </h1>
            <button className="mt-[43px] w-[265px] h-[78px] rounded-[39px] bg-[#A34411] text-white text-[26px] font-normal leading-[65px] text-center">Get Passes</button>
          </div>
